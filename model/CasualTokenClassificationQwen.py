...
class Qwen2ForCausalLM_TokenClassification(Qwen2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        # If we have past_key_values, we only want to process the new tokens
        ...
        if inputs_embeds is not None and past_key_values is None:
            ...
            # The `contiguous()` here is necessary to have a fixed stride (of 1)
            # which is what the `cuda` backend expects.
